    ...
    <div class="container">
      <div class="wp-inner">
        ...
        <div class="section card" id="selling-product" >
          <div class="tab-bar" id="tab-bar-listing" v-if="sellingProducts">
            <p class="btn-tab-bar selected" data="1">TOP SELLERS</p>
          </div>
          <div class="listing">
            <div class="listing-content row">
              <div class="item-listing col-6 col-sm-3" v-for="product in sellingProducts">
    ...
    const getApi = () => {
      axios.get(baseUrl + '/api/home')
        .then(function (response) {
          ...
          sellingProducts.value = response.data.selling_products;
